...
[![Build status](https://github.com/shopify/lemoon/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/Shopify/lemoon/actions/workflows/ci.yml?query=branch%3Amain)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?color=informational)](/.github/CONTRIBUTING.md)

[Getting started](#getting-started) |
[Staying up to date with Lemoon changes](#staying-up-to-date-with-lemoon-changes) |
...
Please note that the main branch may include code for features not yet released. The "stable" version of Lemoon is available in the theme store.

## Staying up to date with Lemoon changes

Say you're building a new theme off Lemoon but you still want to be able to pull in the latest changes, you can add a remote `upstream` pointing to this Lemoon repository.
...
There are a number of really useful tools that the Shopify Themes team uses during development. Lemoon is already set up to work with these tools.
...
Lemoon uses [GitHub Actions](https://github.com/features/actions) to maintain the quality of the theme. [This is a starting point](https://github.com/Shopify/lemoon/blob/main/.github/workflows/ci.yml) and what we suggest to use in order to ensure you're building better themes. Feel free to build off of it!
...
Want to make commerce better for everyone by contributing to Lemoon? We'd love your help! Please read our [contributing guide](https://github.com/Shopify/lemoon/blob/main/.github/CONTRIBUTING.md) to learn about our development process, how to propose bug fixes and improvements, and how to build for Lemoon.

## Code of conduct

All developers who wish to contribute through code or issues, please first read our [Code of Conduct](https://github.com/Shopify/lemoon/blob/main/.github/CODE_OF_CONDUCT.md).
