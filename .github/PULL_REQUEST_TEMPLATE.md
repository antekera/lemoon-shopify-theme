...
### Checklist
- [ ] Added PR summary for [release notes](https://themes.shopify.com/themes/lemoon/styles/default#ReleaseNotes)
- [ ] Requested review from UX (Only for changes that are affecting the experience or perceivable visual details)
- [ ] Created a ticket for the [help.shopify.com](https://help.shopify.com) documentation team about updates to theme settings. (Internal-only task)
- [ ] Followed [theme code principles](https://github.com/Shopify/lemoon/blob/main/.github/CONTRIBUTING.md#theme-code-principles)
